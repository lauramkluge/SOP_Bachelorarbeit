% Laguerre-Sobolev polynomials 
close all
clearvars
n = 20; s = 1; nd = [n n]; same = 1;
alpha = 2;
% alpha = 16;
a0 = alpha + 1;
...
for gamma_index = 1:length(gamma_values)
    ...
    for k = 1:iter
        ...
        D_Aufteilung = sort(D_Aufteilung, 'ComparisonMethod','real'); % bei HH entstehen vernachlässigbar große imaginäre Anteile
